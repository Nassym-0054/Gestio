...
<div class="mynotes">
    ...
    <div class="list-news">
        <div class="option">
            <div class="sousOption" id="shadow-box1">
                ...
                <form action="traitementProf/updatemdp.php" method="POST">
            ...
            <div class="sousOption" id="shadow-box2">
                ...
                <form action="traitementProf/defineProfilImage.php" method="POST" enctype="multipart/form-data">
                    <!--i doubd it-->
    ...
    <div class="etublock">
        ...
        $bdd = new PDO('mysql:host=localhost;dbname=gestioDB', 'root', '', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
        */
        $req = $bdd->prepare('SELECT p.nom_prof,p.prenom_prof,p.id_Prof,p.quota_heure,p.email,m.nom_mat 
                                FROM professeur p INNER JOIN matiere m
                                ON p.id_Prof=m.id_prof1
                                WHERE p.id_Prof=?');
        ...
        <?php /*var_dump($donne)*/ ?>
        <div>
            <p class="infouser">Identifiant: <?php echo $donne['id_Prof'] ?></p>
            <p class="infouser">Nom: <?php echo $donne['nom_prof'] ?></p>
            <p class="infouser">Prenoms: <?php echo $donne['prenom_prof'] ?></p>
        </div>
        <div>
            <p class="infouser">email: <?php echo $donne['email'] ?></p>
            <p class="infouser">Matière: <?php echo $donne['nom_mat'] ?></p>
            <p class="infouser">Quota horaire: <?php echo $donne['quota_heure'] ?></p>
        </div>
    </div> <br>
