    ...
    <div class="mybar"></div><br>
        ...
        */
        ...
        <?php
            ...
            if($req1)
            {
                $req2=$bdd->query('SELECT pub.id_pub, pub.titre_pub, pub.messages, pub.date_envoie, auth.nom, auth.prenom, auth.id
            ...
            ?>
                <div class="communiquer">
                    ...
                    <form action="traitementAdmin/del-publication.php" method="POST">
                        <span class="bloc-i">
                            <input class="shadow-input-i" type="text" name="id_publication" value="<?php echo $pub['id_pub']; ?>"/>
                            <i class="fa fa-trash icon-trash"></i>
                            <input class="resp-i" type="submit" value="" />
                        </span>
                    </form> 
